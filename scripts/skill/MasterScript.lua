...
function CanLearnSkill(player, dwSkillID, dwSkillLevel, dwMasterID)
	...
	if dwMasterID == 49 then		--新增门派导师
		if player.dwForceID == 213 then
			return true
		end
	end
	
	if dwMasterID == 47 then		--新增门派导师
		if player.dwForceID == 211 then
			return true
		end
	end
	if dwMasterID == 48 then		--新增门派导师
		if player.dwForceID == 212 then
			return true
		end
	end
	if dwMasterID == 47 then		--新增门派导师
	...
	if dwMasterID == 46 then		--凌雪阁技能导师
		if player.dwForceID == 25 then
			return true
		end
	end

	if dwMasterID == 45 then		--蓬莱技能导师
		if player.dwForceID == 24 then
			return true
		end
	end
