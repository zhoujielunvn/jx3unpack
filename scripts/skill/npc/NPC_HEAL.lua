...
tSkillData =
{
     {nCostMana = 15, nHeal = 85, nMaxRadius = 5, nAngleRange = 256, nPrepareFrames = 0, nBulletVelocity = 0, nBreakRate = 1024},--万花NPC  方仲归                            容光焕发
	 {nCostMana = 15, nHeal = 135, nMaxRadius = 5, nAngleRange = 256, nPrepareFrames = 0, nBulletVelocity = 0, nBreakRate = 1024},--万花NPC  迦罗甲士、修罗甲士    快速修理
