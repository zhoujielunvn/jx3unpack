...
function OnAddAbsorbShield(character)
	--print(22222)
end

--第一个参数是作用目标的对象，第二个是释放者的ID，一定注意,盾之间的替换不会触发这个脚本
function OnRemoveAbsorbShield(character)
	...
	target.DelBuff(9334, 2)
	target.DelBuff(9334, 3)
	target.DelBuff(9334, 4)
	target.DelBuff(16911, 1)
end